...
import com.erengulbahar.dryapp.databinding.FragmentAppointmentDetailsBinding;
...
public class AppointmentDetails extends Fragment
{
    ...
    private FragmentAppointmentDetailsBinding appointmentDetailsBinding;
    Calendar calendar;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        appointmentDetailsBinding = FragmentAppointmentDetailsBinding.inflate(inflater,container,false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState)
    {
        ...
        name = view.findViewById(R.id.nameText3);
        surname = view.findViewById(R.id.surnameText3);
        address = view.findViewById(R.id.addressText3);
        phone = view.findViewById(R.id.phoneNumber3);
        count = view.findViewById(R.id.countText3);
        totalPrice = view.findViewById(R.id.totalPrice3);
        ...
        if(getArguments() != null)
        {
            ...
            String pos = AppointmentDetailsArgs.fromBundle(getArguments()).getId();
    ...
    public void deleteData(View view)
    {
        ...
        {
            firebaseFirestore.collection("Appointments").whereEqualTo("docId",myId).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                @Override
                public void onComplete(@NonNull Task<QuerySnapshot> task)
                {
                    if(task.isComplete() && !task.getResult().isEmpty())
                    {
                        ...
                        firebaseFirestore.collection("Appointments").document(documentId).delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
                            public void onSuccess(Void unused)
                            {
                                Toast.makeText(getContext(),"Data has been deleted successfully !",Toast.LENGTH_SHORT).show();
                                NavDirections action = AppointmentDetailsDirections.actionAppointmentDetailsToAppointmentList();
